...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "VFX Compositor with years of experience delivering invisible visual effects for feature films, episodic television, and high-end advertising." },
      { name: "author", content: "GEEBIN A R" },
      { property: "og:title", content: "GEEBIN A R — VFX Compositor | Video Editor" },
      { property: "og:description", content: "VFX Compositor with years of experience delivering invisible visual effects for feature films, episodic television, and high-end advertising." },
